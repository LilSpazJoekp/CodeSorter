#!/usr/bin/env python3
"""Set or bump the package version.

Usage:
    tools/set_version.py <version> # release: write the given version and date
    tools/set_version.py Unreleased # post-release: add Unreleased header and bump dev
...
CHANGELOG_HEADER = "############\n Change Log\n############\n\n"
UNRELEASED_HEADER = "************\n Unreleased\n************\n\n"
VERSION_FILE = "codesorter/const.py"
